    ...
    <div className="mx-auto w-full max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
      <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        ...
        <p className="mt-3 max-w-2xl text-slate-600">
          Keep your programme profile current and manage security without changing your trusted role or school entitlements.
        </p>
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="space-y-6">
                ...
                <div className="mt-6 space-y-5">
                  ...
                  <div>
                    ...
                    <input
                      id="alias"
                      name="alias"
                      defaultValue={viewer.leaderboardAlias || viewer.displayName}
                      maxLength={24}
                      className="mt-2 w-full rounded-2xl border border-slate-300 px-4 py-3 outline-none transition focus:border-emerald-600 focus:ring-4 focus:ring-emerald-100"
                    />
                  </div>
            ...
            <form action={updateDisplaySettings} className="space-y-6">
              <section id="leaderboard" className="rounded-3xl border border-slate-200 bg-slate-50 p-5">
                <p className="text-sm font-semibold text-slate-800">Leaderboard and privacy</p>
                ...
                <button type="submit" className="mt-5 w-full rounded-2xl bg-emerald-600 px-5 py-3 font-semibold text-white transition hover:bg-emerald-700">
            ...
            <form action={updatePassword} className="space-y-6">
              <section id="security" className="rounded-3xl border border-slate-200 bg-slate-50 p-5">
                <p className="text-sm font-semibold text-slate-800">Password and security</p>
                ...
                <button type="submit" className="mt-5 w-full rounded-2xl bg-slate-950 px-5 py-3 font-semibold text-white transition hover:bg-slate-800">
                  Update password
                </button>
              </section>
            </form>
          ...
          <aside className="space-y-6">
            <section id="account" className="rounded-3xl border border-slate-200 bg-slate-50 p-5">
              ...
              <dl className="mt-4 space-y-3 text-sm text-slate-700">
                ...
                <div className="flex justify-between gap-4"><dt>Email</dt><dd className="break-all">{viewer.email}</dd></div>
                <div className="flex justify-between gap-4"><dt>Privacy</dt><dd>{viewer.leaderboardOptIn ? "Visible" : "Hidden"}</dd></div>
                <div className="flex justify-between gap-4"><dt>Avatar</dt><dd className="capitalize">{viewer.avatar}</dd></div>
              </dl>
              <a href="/profile" className="mt-5 inline-flex text-sm font-semibold text-emerald-700 hover:text-emerald-800">
